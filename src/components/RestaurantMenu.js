   ...
   const[namee,setName]=useState("")
       useEffect(()=>{
           async function fetchResData(){
               ...
               setResChain(newdata);
               setName(data?.data?.cards[0]?.card?.card?.text)
    ...
    //    console.log(resChain)
       ...
       return (
        <div className="w-[70%] mx-auto">
            ...
            <h1 className="text-center font-semibold font-serif text-2xl mt-5">{namee}</h1>
            <div className="h-10 text-center text-xl rounded-xl border-2 mt-10">
